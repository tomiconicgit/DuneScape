export default class DeveloperUI {
    ...
    // ... (updateTime and showCopiedFeedback are the same)
    ...
    _createDOM() {
        // ... (UI container and panel setup is the same)
        ...
        lightGroup.appendChild(this._createSlider('sunIntensity', 'Sun Intensity', 0, 5, 0.1, 1.0));
        
        // MODIFIED: Added God Rays slider
        lightGroup.appendChild(this._createSlider('godRayIntensity', 'God Ray Intensity', 0, 1, 0.01, 0.75));
        lightGroup.appendChild(this._createSlider('exposure', 'Exposure', 0, 1, 0.01, 0.5));
        this.dom.panel.appendChild(lightGroup);

        // ... (rest of the DOM creation is the same)
    ...
    // ... (_createGroup, _createButton, _createSlider are the same)
