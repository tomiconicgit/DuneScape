...
export default class Navbar {
    ...
    // MODIFIED: This function now handles toggling the active tab
    _handleTabClick(name) {
        ...
        // If a different tab was active, hide it first.
        if (this.activePanel) {
            this.panels[this.activePanel].hide();
            this.buttons[this.activePanel].classList.remove('active');
        }

        // Show the new active tab and panel.
    ...
    _injectStyles() {
        ...
        style.textContent = `
            ...
            #ui-container { position: fixed; bottom: 0; left: 0; right: 0; z-index: 2; display: flex; flex-direction: column-reverse; height: 35vh; }
            ...
            #navbar { border-radius: 24px 24px 0 0; border-bottom: none; }
            ...
            #panel-content { flex: 1; min-height: 0; border-top: none; }
