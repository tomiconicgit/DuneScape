...
export default class Navbar {
    ...
    _createDOM() {
        ...
        this.dom.navbar.id = 'navbar';
        this.dom.navbar.innerHTML = `<div class="glass-filter"></div><div class="glass-overlay"></div><div class="glass-specular"></div><div class="glass-content" id="navbar-content"></div>`;
        const navbarContent = this.dom.navbar.querySelector('#navbar-content');
        
        this.dom.panelContent.id = 'panel-content';
        this.dom.panelContent.innerHTML = `<div class="glass-filter"></div><div class="glass-overlay"></div><div class="glass-specular"></div><div class="glass-content" id="panel-content-area"></div>`;
        const panelContentArea = this.dom.panelContent.querySelector('#panel-content-area');
    ...
    _injectStyles() {
        ...
        style.textContent = `
            ...
            /* --- Base Glass Styles --- */
            #navbar, #panel-content { position: relative; border: 1px solid rgba(100, 100, 110, 0.2); overflow: hidden; }
            ...
            #navbar {
                ...
                border-top: 1px solid rgba(100, 100, 110, 0.3);
            }
            #navbar-content { display: flex; justify-content: space-around; align-items: stretch; }
            #navbar button {
                background: none; border: none; color: #aaa; flex: 1;
