...
export default class Game {
  constructor() {
      ...
      this.camera.threeCamera.layers.enable(1); // render player layer

      window.loader.updateStatus('Entities created...', 80);
      
      this.setupRenderer();
      
      // NEW: Player customisation panel (now at top, non-blocking)
  ...
  animate() {
      ...
      // always allow player to update (build mode is unused by the new dev UI)
