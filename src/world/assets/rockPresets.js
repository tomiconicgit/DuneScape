...
export const rockPresets = {
    ...
    // ✨ OPTIMIZED: Lowered detail for faster generation of decorative stones
    "Stone 1": {
        detail: 4, displacement: 0.3, metalness: 0.3, radius: 1.5,
        aoParam: v2(1, 1.4), cornerParam: v2(0.35, 40),
    ...
    "Sandstone": {
        detail: 5, displacement: 0.3, metalness: 0, radius: 1.5,
