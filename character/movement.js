...
const Movement = {
    ...
    /**
     * Places a marker at the target position.
    ...
    /**
     * Calculates the path to the target using A*.
     * @param {Object} targetGrid - Target grid position {x, z}.
     */
    ...
    /**
     * Updates the character's position along the path.
    ...
    /**
     * A* pathfinding on the grid (4-way movement, no obstacles yet).
     * @param {Object} start - Start grid {x, z}.
     * @param {Object} goal - Goal grid {x, z}.
     * @returns {Array} Path of grid points.
     */
    findPath(start, goal) {
        const openSet = [];
